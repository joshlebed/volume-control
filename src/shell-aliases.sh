...
alias volume-control-start='nohup python3.11 ~/code/volume-control/src/volume_control.py &> /tmp/nohup.out & disown'
alias volume-control-start-foreground='python3.11 ~/code/volume-control/src/volume_control.py'
