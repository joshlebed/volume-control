...
NUMPAD_DISCO_LIGHT_TOGGLE_SHOW_TRIGGER = STAR_CODE
...
class Coordinator:
    ...
    def handle_keyboard_event(self, event):
        ...
        if event.value == 1:
            ...
            elif event.code == NUMPAD_DISCO_LIGHT_TOGGLE_SHOW_TRIGGER:
                self.start_task(self.remote.toggle_disco_light_show())
